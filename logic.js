...
//https://en.wikipedia.org/w/api.php?action=parse&format=json&prop=text&section=0&page=dalmation+(dog)&callback=?
//https://en.wikipedia.org/w/api.php?action=parse&format=json&prop=text&section=0&page=Dutch+Shepherd+Dog&callback=?
                ...
                //"<div class='col sm12 m6 l4'>" +
                    "<div class='card small'>" + 
                        "<div class='card-image waves-effect waves-block waves-light'>" +
                            "<img class='activator' src='" + petData.petfinder.pets.pet[i].media.photos.photo[2].$t + "'>" + 
                        "</div>" + 
                        "<div class='card-content animalFront'>" + 
                            "<div class='title'>" +
                            "<span class='card-title activator grey-text text-darken-4 title'>" +
                                "<div id='animalTitle'><b>Name: </b>" + petData.petfinder.pets.pet[i].name.$t + "</div>" + "<br>" +
                                "<div id='animalTitle'><b>Gender: </b>" + petData.petfinder.pets.pet[i].sex.$t + "</div>" + "<br>" +
                        ...
                        "<div class='card-reveal'>" + 
                            "<span class='card-title grey-text text-darken-4 title'>" +
                                "<b>" + petData.petfinder.pets.pet[i].name.$t + "</b>" + 
